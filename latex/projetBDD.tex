...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{modelEA.pdf}https://preview.overleaf.com/public/fmggjjhwnrrs/images/8586f5f52acf38bd1764f56ff49298182f11036b.jpeg
...
\item Un \textit{User} ne peut pas donner deux likes/dislikes sur un \textit{Comment}.
\end{itemize}
...
\item $CommentLikes.Likes \in \{True,False\} $
